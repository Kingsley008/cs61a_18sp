class Player(object):
    ...
    def go_to(self, location):
        ...
        elif self.place.name == destination_place:
    ...
    def talk_to(self, person):
        ...
        if type(person) != str:
            ...
            Chara = self.place.characters.get(person, 0)
            if Chara:
    ...
    def take(self, thing):
        ...
        if type(thing) != str:
            ...
            th = self.place.things.get(thing, 0)
            if th:
                print('Player takes the ' + th.name)
                self.backpack.append(th)
                self.place.things.pop(thing, 0)
            else:
