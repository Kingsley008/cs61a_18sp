...
def tree_map(fn, t):
    ...
    new_tree.label = fn(new_tree.label)
    def help(tr):
        if tr.is_leaf():
            return
        for tr in tr.branches:
            tr.label = fn(tr.label)
            help(tr)
