...
def make_restaurant(name, location, categories, price, reviews):
    ...
    # BEGIN Question 2
    "*** YOUR CODE HERE ***"
    # [name, {'location': location, 'categories': categories, 'price': price, 'reviews': reviews}]
    return [name, {'location': location, 'categories': categories, 'price': price, 'reviews': reviews}]
...
def restaurant_ratings(restaurant):
    ...
    "*** YOUR CODE HERE ***"
    ratings = []
    reviews = restaurant[1]['reviews']
    for x in reviews:
        ratings.append(review_rating(x))
    return ratings
    # END Question 2